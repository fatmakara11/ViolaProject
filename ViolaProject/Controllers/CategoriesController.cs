...
namespace ViolaProject_Api.Controllers
{
    ...
    public class CategoriesController : ControllerBase
    {
        ...
        public async Task<IActionResult> KategoriOlustur(KategoriOlustur kategoriOlustur)
        {
            ...
            _kategoriDepo2.KategoriOlustur(kategoriOlustur);
        ...
        [HttpPut]
        public async Task<IActionResult> KategoriGüncelleme(KategoriGüncelleme kategori)
        {
            if (kategori == null)
            {
            ...
            _kategoriDepo2.KategoriGüncelleme(kategori);
